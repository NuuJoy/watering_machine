...
class envDataStore():
    def __init__(self):
        ...
        self.temperature_subplot.camera = vispy.scene.PanZoomCamera(rect=(-24.0,20.0,24.0,20.0),interactive=True)
        ...
        self.humidity_subplot.camera = vispy.scene.PanZoomCamera(rect=(-24.0,0.0,24.0,100.0),interactive=True)
        ...
        self.ambientlight_subplot.camera = vispy.scene.PanZoomCamera(rect=(-24.0,0.0,24.0,5000.0),interactive=True)
    ...
    def temp1_update(self,data):
        ...
        curTime = time.time()
        plot_temp1 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.temp1]
    ...
    def temp2_update(self,data):
        ...
        curTime = time.time()
        plot_temp2 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.temp2]
    ...
    def humd1_update(self,data):
        ...
        curTime = time.time()
        plot_humd1 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.humd1]
    ...
    def humd2_update(self,data):
        ...
        curTime = time.time()
        plot_humd2 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.humd2]
    ...
    def inlx1_update(self,data):
        ...
        curTime = time.time()
        plot_inlx1 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.inlx1]
    ...
    def inlx2_update(self,data):
        ...
        curTime = time.time()
        plot_inlx2 = [[datapoint[0]-curTime,datapoint[1]] if (datapoint[0]-curTime) > -86400.0 else None for datapoint in env.inlx2]
