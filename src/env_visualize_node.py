    ...
    def __init__(self,logfilename,history_hr):
        ...
        try:
            ...
            with open(logfilename,'r') as logfile:
                ...
                while len(line) == 3:
                    if (float(line[1]) - curTime) > -self.history_sec:
...
if __name__ == '__main__' and sys.flags.interactive == 0:
    try:
        ...
        # init data storage
        plot = vispygraph('/home/nuujoy/wmros_ws/logFile.csv',history_hr)
        # init subscriber
        rospy.Subscriber('env_monitor_node/temp1', std_msgs.msg.Float64, plot.temp1_update, queue_size=1)
        rospy.Subscriber('env_monitor_node/temp2', std_msgs.msg.Float64, plot.temp2_update, queue_size=1)
        rospy.Subscriber('env_monitor_node/humd1', std_msgs.msg.Float64, plot.humd1_update, queue_size=1)
        rospy.Subscriber('env_monitor_node/humd2', std_msgs.msg.Float64, plot.humd2_update, queue_size=1)
        rospy.Subscriber('env_monitor_node/inlx1', std_msgs.msg.Float64, plot.inlx1_update, queue_size=1)
        rospy.Subscriber('env_monitor_node/inlx2', std_msgs.msg.Float64, plot.inlx2_update, queue_size=1)
